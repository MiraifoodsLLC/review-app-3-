    ...
    <main style={{ maxWidth: 420, margin: "0 auto", padding: "1rem", fontFamily: "sans-serif" }}>
      {screen === "survey" ? (
        ...
        <>
          ...
          <button onClick={handlePost} style={{ width: "100%", padding: 13, borderRadius: 8, border: "none", fontSize: 15, cursor: "pointer", background: "#dbeafe", color: "#1d4ed8", fontWeight: 500, marginBottom: 8 }}>
            Googleマップに投稿する ↗
          </button>
